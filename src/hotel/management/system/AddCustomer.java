...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer()
    {
        ...
        box1 = new JComboBox(new String[]{"Passport" , "Votr-id Card" , "Driving License" , "Aadhar Card"});
        box1.setBounds(200,80,150,25);
        add(box1);
        box1.setBackground(Color.WHITE);
        
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/fifth.png"));
        Image img1 = img.getImage().getScaledInstance(300,400,Image.SCALE_DEFAULT);
        JLabel ilab = new JLabel(new ImageIcon(img1));
        ilab.setBounds(400,50,300,400);
        add(ilab);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == b1)
        {
            String id = (String) box1.getSelectedItem();
            ...
            String room = (String)ch.getSelectedItem();
            String status = t4.getText();
            String deposit = t5.getText();
            try{
            
                conn c = new conn();
                String query = "insert into customer values ('" + id+ "','"+number+"','"+name+"','"+gender+"','"+country+"','"+room+"','"+status+"','"+deposit+"');";
                c.s.executeUpdate(query);
                String query1 = "update room set available = 'Occupied' where num = '"+room+"';";
